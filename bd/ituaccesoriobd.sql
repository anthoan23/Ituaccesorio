...
CREATE TABLE `Entrega_inventario` (
  `ID_entrega_inventario` int NOT NULL AUTO_INCREMENT,
...
CREATE TABLE `Fotos_inventario` (
  `ID_foto_inventario` int NOT NULL AUTO_INCREMENT,
  `ID_inventario` int DEFAULT NULL,
...
CREATE TABLE `Fotos_orden_servicio` (
  `ID_foto_orden_servicio` int NOT NULL AUTO_INCREMENT,
...
CREATE TABLE `Fotos_trade_in` (
  `ID_foto_trade_in` int NOT NULL AUTO_INCREMENT,
  `ID_Trade_in` int DEFAULT NULL,
...
CREATE TABLE `Orden_servicio` (
  ...
  KEY `ID_producto` (`ID_producto`),
  KEY `ID_cliente` (`ID_cliente`),
  CONSTRAINT `Orden_servicio_ibfk_1` FOREIGN KEY (`ID_producto`) REFERENCES `Producto` (`ID_producto`),
...
CREATE TABLE `Trade_in` (
  ...
  `Liberado` varchar(10) DEFAULT NULL,
...
-- Dump completed on 2026-05-30  0:17:00
