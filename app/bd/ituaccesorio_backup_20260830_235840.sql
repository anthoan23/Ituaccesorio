...
('162537612473417', '1', 'Rojo', '64GB', 1111, '456'),
('453223456789009', '1', 'Rojo', '64GB', 1111, '456'),
('543245234532452', '1', 'Rojo', '64GB', 1111, '456'),
...
('11', '6', '7', 'LG AUDIFONOS', 'AUDIFONOS LG'),
...
('TST000132', 1, 'Botón power', 'Pendiente'),
('TST000133', 1, 'Botones volumen', 'Funciona'),
('TST000134', 1, 'Botones laterales', 'Pendiente'),
('TST000135', 1, 'Botones inferiores', 'Pendiente'),
('TST000136', 1, 'Cornetas', 'Pendiente'),
('TST000137', 1, 'Micrófono', 'Pendiente'),
('TST000138', 1, 'Altavoz', 'Pendiente'),
('TST000139', 1, 'Mica', 'Pendiente'),
('TST000140', 1, 'LCD', 'Pendiente'),
('TST000141', 1, 'Táctil', 'Pendiente'),
('TST000142', 1, 'Puerto de carga', 'Pendiente'),
('TST000143', 1, 'WiFi', 'Pendiente'),
('TST000144', 1, 'Bluetooth', 'Pendiente'),
('TST000145', 1, 'GPS', 'Pendiente'),
('TST000146', 1, 'NFC', 'Pendiente'),
('TST000147', 1, 'Cámara trasera', 'Pendiente'),
('TST000148', 1, 'Cámara delantera', 'Pendiente'),
('TST000149', 1, 'Flash', 'Pendiente'),
('TST000150', 1, 'Sensor de proximidad', 'Pendiente'),
('TST000151', 1, 'Face ID', 'Pendiente'),
('TST000152', 1, 'Batería', 'Pendiente'),
('TST000153', 1, 'Vibrador', 'Pendiente');
...
CREATE TABLE `Trade_in` (
  `ID_Trade_in` varchar(16) NOT NULL,
  `ID_empleado` int DEFAULT NULL,
  `ID_cliente` varchar(12) DEFAULT NULL,
  `ID_inventario` varchar(10) DEFAULT NULL,
  `ID_equipo` varchar(16) DEFAULT NULL,
...
('TRD000001', 32014004, '55678901', NULL, '453223456789009', 0, '2026-08-30 23:58:22', '400.00');
