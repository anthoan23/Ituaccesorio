...
('CRG0000001', 'Prueba-1', 'Esta es la descripciÃ³n detallada para la prueba'),
('CRG0000002', 'Prueba-2', 'Esta es la descripciÃ³n detallada para la prueba 2'),
('CRG0000003', 'Prueba-3', 'Esta es la descripciÃ³n detallada para la prueba 3'),
('CRG0000004', 'Prueba-4', 'Esta es la descripciÃ³n detallada para la prueba 4'),
('CRG0000005', 'Prueba-5', 'Esta es la descripciÃ³n detallada para la prueba 5'),
('CRG0000006', 'TÃ©cnico', 'Encargado de las revisiones y reparaciones'),
('CRG0000007', 'Vendedor', 'Encargado de ventas y atenciÃ³n al cliente'),
...
('CRG0000011', 'Soporte TÃ©cnico', 'Soporte tÃ©cnico especializado');
...
('55678901', 'San CristÃ³bal', '04181234567', 'cliente4@gmail.com'),
...
(20123456, 'CRG0000007', 'Laura', 'SÃ¡nchez', '04121234568', 'laura.sanchez@itu.com', 'Caracas'),
(20234567, 'CRG0000008', 'Carlos', 'Mendoza', '04161234569', 'carlos.mendoza@itu.com', 'Barquisimeto'),
(20345678, 'CRG0000009', 'Roberto', 'GarcÃ­a', '04141234570', 'roberto.garcia@itu.com', 'Cabudare'),
(20456789, 'CRG0000010', 'Daniela', 'Rojas', '04241234571', 'daniela.rojas@itu.com', 'Lara'),
(20567890, 'CRG0000011', 'Fernando', 'LÃ³pez', '04121234572', 'fernando.lopez@itu.com', 'Barquisimeto'),
...
('ENT000004', 'FAC-202606-444444', '25000001', 1, 'San CristÃ³bal - Centro', '2026-06-06 16:00:00'),
('ENT000005', 'FAC-202606-555555', '25000004', 0, 'Puerto La Cruz - Paseo ColÃ³n', NULL);
...
('ESP0000001', 'Prueba-1', 'Esta es la descripciÃ³n detallada para la prueba 1'),
('ESP0000002', 'Prueba-2', 'Esta es la descripciÃ³n detallada para la prueba  2'),
('ESP0000003', 'Prueba-3', 'Esta es la descripciÃ³n detallada para la prueba 3'),
('ESP0000004', 'ReparaciÃ³n iOS', 'Especialista en reparaciÃ³n de dispositivos Apple'),
('ESP0000005', 'ReparaciÃ³n Android', 'Especialista en reparaciÃ³n de dispositivos Android'),
('ESP0000006', 'Cambio de Pantalla', 'Especialista en cambio de pantallas'),
('ESP0000007', 'ReparaciÃ³n Placa', 'Especialista en reparaciÃ³n de placas madre'),
...
('INT000001', 'OS0000001', 32014004, 'RevisiÃ³n'),
...
('INT000008', 'OS0000001', 32014004, 'RevisiÃ³n'),
('INT000009', 'OS0000001', 32014004, 'RevisiÃ³n'),
('INT000010', 'OS0000005', 32014004, 'RevisiÃ³n'),
('INT000011', 'OS0000001', 32014004, 'RevisiÃ³n'),
('INT000012', 'OS0000001', 32014004, 'RevisiÃ³n'),
...
('INT000023', 'OS0000002', 32014004, 'RevisiÃ³n'),
('INT000024', 'OS0000002', 32014004, 'RevisiÃ³n'),
('INT000025', 'OS0000002', 32014004, 'RevisiÃ³n'),
('INT000026', 'OS0000001', 32014004, 'En proceso'),
('INT000027', 'OS0000001', 32014004, 'Reparada'),
('INT000028', 'OS0000001', 32014004, 'RevisiÃ³n'),
('INT000029', 'OS0000004', 32014004, 'Reparada'),
('INT000030', 'OS0000004', 32014004, 'RevisiÃ³n'),
...
('INT000037', 'OS0000025', 32014004, 'RevisiÃ³n'),
...
('OS0000006', 'EQ0000005', '30548845', 'En proceso', 'DiagnÃ³stico', '0.00', 'Equipo sin evaluar', '2026-06-07 09:30:00', NULL),
('OS0000020', 'EQ0000001', '22345678', 'Pendiente', NULL, '0.00', 'Pendiente revisiÃ³n de pantalla', '2026-06-24 11:45:27', NULL),
('OS0000021', 'EQ0000002', '22345678', 'Pendiente', NULL, '0.00', 'Revisar puerto de carga', '2026-06-24 11:45:27', NULL),
('OS0000022', 'EQ0000003', '44567890', 'Pendiente', NULL, '0.00', 'Falla crÃ­tica de encendido', '2026-06-24 11:45:27', NULL),
('OS0000023', 'EQ0000004', '55678901', 'Asignada', NULL, '0.00', 'BaterÃ­a inflada', '2026-06-24 11:45:27', NULL),
...
('OS0000028', 'EQ0000002', '22345678', 'En proceso', 'Desensamblando mÃ³dulo de pantalla daÃ±ado', '85.00', NULL, '2026-06-24 11:45:27', NULL),
...
('OS0000033', 'EQ0000002', '44567890', 'Asignada', 'Removiendo pegamento viejo para cambio de baterÃ­a', '45.00', NULL, '2026-06-24 11:45:27', NULL),
...
('1', 'Sinforoza', 'Petra'),
('22345678', 'GonzÃ¡lez', 'Carlos'),
('30548845', 'Test', 'Cliente'),
('31143265', 'Rodriguez', 'Manuel'),
('33456789', 'RodrÃ­guez', 'Ana'),
('44567890', 'PÃ©rez', 'Luis'),
('55678901', 'DÃ­az', 'MarÃ­a'),
('66789012', 'FernÃ¡ndez', 'JosÃ©'),
...
('25000001', 'Pedro', 'RamÃ­rez'),
('25000002', 'MarÃ­a', 'Torres'),
('25000003', 'Juan', 'Castillo'),
('25000004', 'Luisa', 'Morales'),
('25000005', 'AndrÃ©s', 'Vargas');
...
('10', '7', '4', 'BaterÃ­a Xiaomi', 'BaterÃ­a original Xiaomi'),
...
('7', '4', '2', 'Cargador 20W', 'Cargador rÃ¡pido 20W USB-C'),
('8', '5', '1', 'Funda iPhone', 'Funda protectora para iPhone'),
('9', '6', '6', 'FreeBuds Pro', 'AudÃ­fonos Huawei FreeBuds Pro');
...
-- ----------------------------------------------------
INSERT INTO `Proveedor` (`ID_proveedor`, `Nombre_proveedor`, `Tipo_proveedor`, `Celular_proveedor`, `Correo_proveedor`, `Direccion_proveedor`, `Limite_credito`, `Rif_proveedor`) VALUES
(1, 'Distribuidora Tech Sa', 'Nacional', '04121234501', 'ventas@distritech.com', 'Caracas', '50000.00', 'J-12456897-9'),
(2, 'Importaciones Digitales C.A.', 'Importador', '04141234501', 'contacto@importdigital.com', 'Maracaibo', '75000.00', NULL),
(3, 'Repuestos Express', 'Minorista', '04241234502', 'info@repuestosexpress.com', 'Valencia', '25000.00', NULL),
(4, 'Global Parts', 'Mayorista', '04161234503', 'sales@globalparts.com', 'Barquisimeto', '100000.00', NULL),
(5, 'Suministros MÃ³viles', 'Distribuidor', '04181234504', 'ventas@suministrosmoviles.com', 'San CristÃ³bal', '30000.00', NULL),
(6, 'Prueba Juan', 'Nacional', '04120754888', 'correo@correo.com', 'prueba juan', '5000.00', 'J-12345672-9'),
(7, 'TechPrueba', 'Nacional', '04120744859', 'correo@correo.com', 'TechPrueba', '2500.00', 'J-13245678-9');
...
('TST000001', 1, 'Prueba de BaterÃ­a', 'Funciona'),
('TST000002', 1, 'Prueba de Pantalla', 'No funciona'),
('TST000003', 1, 'Prueba de CÃ¡mara', 'SIn revisar'),
('TST000004', 4, 'Prueba de Botones', 'Todos los botones funcionales'),
('TST000005', 5, 'Prueba de Audio', 'Audio y micrÃ³fono operativos'),
...
('TST000022', 3, 'CÃ¡mara trasera', 'Funciona'),
('TST000023', 3, 'CÃ¡mara delantera', 'Funciona'),
('TST000024', 3, 'Flash', 'Funciona'),
('TST000025', 3, 'SeÃ±al auricular', 'Funciona'),
('TST000026', 3, 'MicrÃ³fono', 'Funciona'),
...
('TST000033', 3, 'AudÃ­fonos', 'Funciona'),
...
-- 1. Buscamos el ID mÃ¡s alto actual en la tabla Cargo
SELECT MAX(`ID_cargo`) INTO ultimo_id FROM `Cargo`;

-- 2. Si la tabla estÃ¡ vacÃ­a, empezamos en 1.
--    Si ya hay datos, extraemos los nÃºmeros (desde la posiciÃ³n 4) y sumamos 1.
...
-- 1. Buscamos el ID mÃ¡s alto actual en la tabla Especialidad
...
-- Datos del cliente (a travÃ©s de Orden_servicio)
os.ID_cliente,
pn.Nombre_cliente,
pn.Apellido_cliente,
c.Celular_cliente,
...
LEFT JOIN Persona_natural pn ON c.ID_cliente = pn.ID_cliente  -- LEFT JOIN porque puede ser cliente jurÃ­dico tambiÃ©n
...
-- Verificar que no estÃ© asignada
IF v_estado_actual = 'Asignada' THEN
SIGNAL SQLSTATE '45000'
SET MESSAGE_TEXT = 'La orden de servicio ya estÃ¡ asignada';
END IF;

-- 2. Verificar que no exista una interacciÃ³n con acciÃ³n 'Asignada' para esta orden
...
SIGNAL SQLSTATE '45000'
SET MESSAGE_TEXT = 'La orden de servicio ya tiene un registro de asignaciÃ³n previa';
END IF;
...
-- 4. Generar nuevo ID para la interacciÃ³n
...
-- Verificar que estÃ© asignada (solo se puede liberar una orden asignada)
IF v_estado_actual != 'Asignada' THEN
SIGNAL SQLSTATE '45000'
SET MESSAGE_TEXT = 'La orden de servicio no estÃ¡ asignada, no se puede liberar';
END IF;

-- 2. Verificar que exista una interacciÃ³n con acciÃ³n 'Asignada' para esta orden
SELECT COUNT(*) INTO v_tiene_asignacion
FROM Interaccion
WHERE ID_orden_servicio = p_ID_orden_servicio
AND Accion = 'Asignada';
...
IF v_tiene_asignacion = 0 THEN
SIGNAL SQLSTATE '45000'
SET MESSAGE_TEXT = 'La orden de servicio no tiene registro de asignaciÃ³n previa';
END IF;
...
-- 4. Modificar la interacciÃ³n existente: cambiar acciÃ³n de 'Asignada' a 'En proceso'
UPDATE Interaccion
...
'InteracciÃ³n actualizada correctamente' AS Mensaje;
...
-- Validar que el JSON no estÃ© vacÃ­o
...
-- CORRECCIÃ“N: Permitir que proceda si estÃ¡ en 'Asignada' o 'En proceso'
...
-- CORRECCIÃ“N: Buscar interacciÃ³n en estado 'Asignada' o 'En proceso'
SELECT ID_interaccion INTO v_id_interaccion_asignada
FROM Interaccion
WHERE ID_orden_servicio = p_ID_orden_servicio
AND Accion IN ('Asignada', 'En proceso')
ORDER BY ID_interaccion DESC -- Trae la Ãºltima interacciÃ³n generada
LIMIT 1;
...
-- CORRECCIÃ“N: Se cambiÃ³ de 'Inventario' a 'Existencias_productos'
...
-- NOTA: AsegÃºrate de tener creada la tabla Repuestos_usados si vas a usar esta secciÃ³n
...
-- CORRECCIÃ“N: Descontar stock de la tabla correcta 'Existencias_productos'
...
IN p_ID_orden_servicio VARCHAR(10),
IN p_ID_empleado INT,
IN p_Num_test INT,            -- El nÃºmero identificador del lote de test
...
-- Iniciamos la transacciÃ³n segura
START TRANSACTION;
...
INSERT INTO `Interaccion` (`ID_interaccion`, `ID_orden_servicio`, `ID_empleado`, `Accion`)
VALUES (v_nuevo_id_interaccion, p_ID_orden_servicio, p_ID_empleado, 'RevisiÃ³n');
...
-- 2.2 Generar el ID_test dinÃ¡mico (Formato 'TST0000001') para este componente especÃ­fico
...
-- CORREGIDO: Usar 'Num_test' (parÃ¡metro) y 'Resultado_test' (columna correcta)
...
-- 2.4 Insertar la relaciÃ³n de los cÃ³digos en la tabla Test_realizados_interaccion
