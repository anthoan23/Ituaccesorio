                    ...
                    <tr>
                        ...
                        <td class="table__actions">
                            <div class="row-actions">
                                ...
                                <button class="icon-action icon-action--success" data-action="registrar-entrega" data-id="${escapeHtml(orden.ID_orden_c)}" title="Registrar entrega" aria-label="Registrar entrega">${Iconos.registro}</button>
                            </div>
                        </td>
                    </tr>
                `).join('');
